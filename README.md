...
- Email (conținut extins)
- SMS (urgențe și remindere)
...
| Fișier | Descriere |
|--------|-----------|
| `instructiune-progrev.md` | Ghid complet pentru campaniile de warmup (template-uri, metrici, checklist) |
| `warmup-strategy-15-27-ianuarie.md` | Strategia inițială (versiunea 1) |
| `strategia-ajustata-v2.md` | **Strategia ajustată** cu sneak peek-uri, demo, diferențiere |
